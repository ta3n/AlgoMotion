...
- [ ] Custom input: accept bounded integers, reject invalid input without changing run; duplicates render. Verify parser
  and browser.
...
- [ ] Graph simulation: BFS/DFS/Dijkstra/Prim correctness, cycles, disconnected nodes and validation; verify regression
  checks.
